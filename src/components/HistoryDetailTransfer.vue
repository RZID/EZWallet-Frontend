<template>
  <div class="py-lg-5">
    <div class="card border-0 shadow card-lg py-4">
      <div class="card-body body-card">
        ...
        <div class="d-flex justify-content-end pt-5">
          <button
            class="btn btn-gray mr-2 text-dark radius-12 px-3 py-2 font-weight-bold d-none d-lg-block"
          >
            <b-icon icon="share"></b-icon>
          </button>
          <button
            class="btn btn-gray mr-2 text-blue radius-12 px-3 py-2 font-weight-bold d-none d-lg-block"
          >
            <b-icon icon="download"></b-icon>
            Download PDF
          </button>
          <button
            class="btn btn-blue radius-12 px-3 py-2 font-weight-bold btn-block d-block d-lg-none"
